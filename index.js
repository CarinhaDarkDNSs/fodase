...
const { color, bgcolor } = require('./lib/colAQUIor')
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			switch(command) {
				...
				case 'dono':
					memein = await kagApi.memeindo()
					buffer = await getBuffer(`https://i.ibb.co/YLnPBNd/IMG-20210109-231453-715.jpg`)
					client.sendMessage(from, buffer, image, {quoted: mek, caption: ' *CRIADOR:* ༺☬MELIODASDOPHP☬C҈ O҈ D҈ E҈ R\n*YOUTUBE:* https://youtube.com/channel/UCrLw4MAR-QWFkURqhw20H9Q\n*WhatsApp:* wa.me/+55389734-8938'})
					break
				case 'belle2':
					memein = await kagApi.memeindo()
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*canal do meliodas:*\n\n https://youtube.com/channel/UCrLw4MAR-QWFkURqhw20H9Q'})
					break
				case 'mia1':
					memein = await kagApi.memeindo()
        ...
        case 'promover':
				...
				case 'kick':
					...
					if (mentioned.length > 1) {
						...
						mentions(`@${mentioned[0].split('@')[0]} KKKKKK acabou de levar ban, otaro!`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
				case 'admins':
